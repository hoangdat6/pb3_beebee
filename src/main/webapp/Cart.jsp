                        ...
                        <div class="Shop_Products">
                            ...
                            <div class="Shop_Products-Content">
                                <div class="Shop_Products-Cell">
                                    ...
                                    <img class="Cell_Col_1" src="img/Product-Details/Category-1.jpeg"
                                        alt="Product Imge">
                                    ...
                                    <div class="Cell_Col_3">
                                        <div class="Item-Qty">
                                            <button class="Item-Qty--Minus btn" onclick="decreaseQuantity(this)"><i
                                                    class="fa-solid fa-minus"></i></button>
                                            <input class="btn Qty__Input" value="1" min="1">
                                            <button class="Item-Qty--Plus btn" onclick="increaseQuantity(this)"><i
