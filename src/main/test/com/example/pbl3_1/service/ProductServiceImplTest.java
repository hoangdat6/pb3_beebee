...
public class ProductServiceImplTest {
    ...
    public void testAddProduct() {
        ...
        ProductItem productItem1 = ProductItem.builder().productId(2L).productImgPath("test2").variation1(1L).variation2(2L).qtyInStock(10).price(1000).build();
        ProductItem productItem2 = ProductItem.builder().productId(2L).productImgPath("test3").variation1(1L).variation2(2L).qtyInStock(10).price(1000).build();
        ProductItem productItem3 = ProductItem.builder().productId(2L).productImgPath("test4").variation1(1L).variation2(2L).qtyInStock(10).price(1000).build();
